    ...
    <main className="min-h-screen bg-[#0B0F1A] text-[#ffffff] py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white/5 border border-[#ffffff]/10 backdrop-blur-md rounded-2xl p-8">
        ...
        <div className="space-y-6 text-sm text-[#ffffff]/60 leading-relaxed">
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">1. Objet</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">2. Accès au service</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">3. Offres et abonnement</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">4. Contenu généré</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">5. Contenu déposé par l'utilisateur</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">6. Résiliation et suppression de compte</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">7. Modification des CGU</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">8. Contact</h2>
