    ...
    <main className="min-h-screen bg-[#0B0F1A] text-[#ffffff] py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white/5 border border-[#ffffff]/10 backdrop-blur-md rounded-2xl p-8">
        ...
        <div className="space-y-6 text-sm text-[#ffffff]/60 leading-relaxed">
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">1. Données collectées</h2>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">2. Utilisation des données</h2>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">3. Sous-traitants et prestataires</h2>
            <p>Pour fonctionner, FishFlow s'appuie sur les prestataires suivants :</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong className="text-[#ffffff]/80">Supabase</strong> — hébergement de la base de données et gestion des comptes</li>
              <li><strong className="text-[#ffffff]/80">OpenAI</strong> — traitement des contenus soumis pour générer les fiches de révision</li>
              <li><strong className="text-[#ffffff]/80">Stripe</strong> — traitement des paiements pour l'abonnement FishFlow Pro</li>
              <li><strong className="text-[#ffffff]/80">Vercel</strong> — hébergement du site</li>
            </ul>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">4. Conservation des données</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">5. Tes droits</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">6. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-[#ffffff] mb-2">7. Contact</h2>
            <p>
